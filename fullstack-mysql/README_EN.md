# Quickly create and deploy fullstack-mysql application

[中文](./README.md) | **English**

## Introduction

Easily deploy fullstack-mysql applications to Tencent Cloud's serverless infrastructure using this Serverless Framework Component.
...
Initializing the fullstack-mysql template by running this following command:
